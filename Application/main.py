...
review_data = review_data[['overall', 'reviewText']][0: review_data.__len__() // 100]
...
# we print that particular case to the console for further analysis. Currently, the threshold for printing is a 20%
# difference (or a factor of 0.2)

for i in range(0, predicted_ratings.__len__()):
    if abs(predicted_ratings[i] - actual_ratings[i])/5 >= 0.2:
